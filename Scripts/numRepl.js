...
function KMBMaker(elem) {
    var num = elem;
    abbvNum = 1;    //Переменная номера аббревеатуры сокращения названий чисел
    ...
    for (i = 1000; ; i = i * 1000) {
        if (num < i) {
            ...
            var text = numStr + arrayRdc[abbvNum - 1];  //Создание строки numStr + Номер аббревеатуры сокращения названия
            break;
        } else if (isNaN(num)) {
            break;
        }
